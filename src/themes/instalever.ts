const theme = {
    ...
    brand: {
      ...
      simpleSteps: {
        ...
        secondStepDescription: 'We execute strategic promotion campaigns through our established network of creators, partnership specialists, email outreach professionals, and advertising channels to increase your Instagram™ account\'s visibility across multiple platforms.',
