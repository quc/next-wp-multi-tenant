const theme ={
    ...
    brand: {
      ...
      simpleSteps: {
        ...
        secondStepDescription: 'We execute strategic promotion campaigns through our established network of creators, partnership specialists, and advertising channels to increase your Spotify™ profile\'s visibility across multiple platforms.',
        thirdStep: '3. Engage with Your Viewer',
        thirdStepDescription: 'Simply provide your Spotify™ profile link, and we\'ll handle the strategic promotion. No complicated setup. Our team works to introduce your profile to new audiences while you focus on creating content.',
      },
      pricing: {
        title: 'Growth Package',
        subtitle: 'Choose the perfect plan for your Spotify™ profile growth needs',
        packages: [
          {
            name: 'EarForge Lite',
            price: '$69',
        ...
        features: [
          {
            ...
            description: 'Our expert team studies your profile category and researches demographic segments in your profile category. We stay current with platform updates to continuously refine our external marketing approach for your profile.'
          },
          ...
          {
            title: 'Secure & Simple',
            description: 'Your promotion campaigns operate through our secure platform with professional-grade data protection. No downloads needed, no passwords required – simply provide your Spotify™ profile details and we manage the marketing execution.'
          },
      ...
      faq: [
        ...
        {
          question: "How Do You Increase My Spotify™ Profile Visibility?",
        ...
        
        {
          ...
          answer: "Yes, absolutely. All our marketing strategies are designed to respect Spotify™'s terms of service and community guidelines. We use only platform-friendly methods and stay current with platform updates to ensure our external marketing approach remains compliant and effective.",
        },
