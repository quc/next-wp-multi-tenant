            ...
            <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                    ...
                    <p className="mb-4 sans-serif-text secondary-textcolor leading-relaxed">
                        This website is operated by {brand.nameFirst} LLC. Throughout the site, the terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to {brand.nameFirst} LLC. {brand.nameFirst} LLC offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
                    </p>
                    <p className="mb-4 sans-serif-text secondary-textcolor leading-relaxed">
                ...
                <div className="mb-8">
                    ...
                    <p className="mb-4 sans-serif-text secondary-textcolor leading-relaxed">
                        {brand.nameFirst} LLC reserves the right at any time and from time to time to modify or discontinue, temporarily or permanently, the Service (or any part thereof) with or without notice. You agree that {brand.nameFirst} LLC shall not be liable to you or to any third party for any modification, suspension or discontinuance of the Service.
                    </p>
                </div>
                ...
                <div className="mb-8">
                    ...
                    <p className="mb-4 sans-serif-text secondary-textcolor leading-relaxed">
                        The Processor&apos;s role is to accept and process credit card, debit card and other types of payments (collectively &quot;Cards&quot;) with respect to sales of the products and services of {brand.nameFirst} LLC through internet-based transactions (&quot;Card Not Present Transactions&quot; or &quot;CNP Transactions&quot;).
                    </p>
                    <p className="mb-4 sans-serif-text secondary-textcolor leading-relaxed">
                        By accepting this Agreement, you authorize {brand.nameFirst} LLC to charge such Cards for products and services purchased on the website.
                    </p>
                </div>
                ...
                <div className="mb-8">
                    ...
                    <p className="mb-4 sans-serif-text secondary-textcolor leading-relaxed">
                        You expressly understand and agree that your use of the service is at your sole risk. The service is provided on an &quot;as is&quot; and &quot;as available&quot; basis. {brand.nameFirst} LLC and its parent, subsidiaries, affiliates, officers, directors, shareholders, employees, agents, attorneys, partners, licensors and other representatives expressly disclaim all warranties of any kind, whether express or implied, including, but not limited to the implied warranties of merchantability, fitness for a particular purpose and non-infringement. {brand.nameFirst} LLC and its parent, subsidiaries, affiliates, officers, directors, shareholders, employees, agents, attorneys, partners, licensors and other representatives make no warranty that: (i) the service will meet your requirements; (ii) the service will be uninterrupted, timely, secure or error-free; (iii) the results that may be obtained from the use of the service will be accurate or reliable; (iv) the quality of any products, services, information or other material purchased or obtained by you through the service will meet your expectations; and (v) any errors in the software will be corrected. Any material downloaded or otherwise obtained through the use of the service is accessed at your own discretion and risk, and you will be solely responsible for any damage to your computer system or loss of data that results from the download of any such material. No advice or information, whether oral or written, obtained by you from {brand.nameFirst} LLC or through or from the service shall create any warranty not expressly stated in the TOS.
                    </p>
                </div>
                ...
                <div className="mb-8">
                    ...
                    <p className="mb-4 sans-serif-text secondary-textcolor leading-relaxed">
                        You may bring claims only on your own behalf. Neither you nor {brand.nameFirst} LLC will participate in a class action or class-wide arbitration for any claims covered by this agreement. You also agree not to participate in claims brought in a private attorney general or representative capacity, or consolidated claims involving another person&apos;s account, if {brand.nameFirst} LLC is a party to the proceeding. Any provision of applicable law notwithstanding, the arbitrator will not have authority to award damages, remedies or awards that conflict with these Terms of Use.
                    </p>
                </div>
